...
<title>Documento sin t&iacute;tulo</title>
	...
	$tipo = $_GET['error'];
	if($tipo==1){
	 	$mensaje = "Error En La Intensidad";
	}if($tipo==2){
	 	$mensaje = "Error Materia Ya Se Encuentra Registrada Con el Mismo Horario";
	}if($tipo==3){
		$mensaje = "Error: Esta Materia Ya Tiene Un Horario Asignado";
	}if($tipo==4){
		$mensaje = "Error: No Puedes Asignar La Misma Hora De Otra Materia Que Se Encuentra En El Mismo Semestre";
	}
